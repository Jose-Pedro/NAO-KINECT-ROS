...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2B3i.pack(_x.info.has_laser, _x.info.has_extended_arms, _x.info.number_of_legs, _x.info.number_of_arms, _x.info.number_of_hands))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.info.has_laser, _x.info.has_extended_arms, _x.info.number_of_legs, _x.info.number_of_arms, _x.info.number_of_hands,) = _struct_2B3i.unpack(str[start:end])
