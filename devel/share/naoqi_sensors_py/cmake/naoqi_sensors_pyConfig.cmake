...
if(NOT "/home/jose/medeiros_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'naoqi_sensors_py' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jose/medeiros_ws/src/naoqi_bridge/naoqi_sensors_py/${idir}'.  Ask the maintainer 'Séverin Lemaignan <severin.lemaignan@epfl.ch>, Vincent Rabaud <vincent.rabaud@gmail.com>' to fix it.")
    endif()
