...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'naoqi_bridge_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jose/medeiros_ws/install/${idir}'.  Ask the maintainer 'Karsten Knese <karsten.knese@gmail.com>' to fix it.")
    endif()
